        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">FlexiShop</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/products?category=sports" className="text-gray-400 hover:text-white">
                  Sports & Outdoors
                </Link>
              </li>
              <li>
                <Link href="/products?category=books" className="text-gray-400 hover:text-white">
                  Books & Media
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-400">support@pixshop.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 FlexiShop. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div className="flex space-x-2">
                  ...
                  <div className="w-8 h-5 bg-blue-500 rounded text-xs text-white flex items-center justify-center">
                    PP
                  </div>
                </div>
              </div>
